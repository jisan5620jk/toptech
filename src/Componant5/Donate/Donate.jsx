      ...
      <div className="Container">
        <div className="grid grid-cols-3 gap-7">
          <div className="col-span-3 lg:col-span-2 rounded-lg pl-10 md:pl-[74px] pt-28 pb-[120px] bg-[url('/images/donate-thumb-1.png')] bg-no-repeat bg-cover bg-center">
            ...
            <h1 className="font-Nunito font-bold text-[22px] leading-8 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[32px] lg:leading-[42px] xl:text-[40px] xl:leading-[50px] 2xl:text-[46px] 2xl:leading-[56px] text-white mt-[14px] mb-6">
          ...
          <div className="col-span-3 lg:col-span-1 pl-10 py-28 rounded-lg bg-[url('/images/donate-thumb-2.png')] bg-no-repeat bg-cover bg-center flex items-center">
            <div>
              <h5 className="font-Nunito font-medium text-[17px] text-white">
                THE ANIMAL
              </h5>
              <h2 className="font-Nunito font-bold text-3xl sm:text-4xl lg:text-3xl xl:text-4xl text-white mt-2 mb-9">
