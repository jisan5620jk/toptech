        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[60px] lg:gap-8 xl:gap-[60px] 2xl:gap-0 items-center">
          <div className="relative inline-block">
            ...
            <div className="text-center border-[8px] border-PrimaryColor-0 rounded-md bg-white w-[218px] h-[228px] flex justify-center items-center flex-col absolute bottom-0 right-0 md:right-[132px] lg:right-0 2xl:right-[76px]">
              ...
              <h5 className="font-Nunito font-medium text-lg text-HeadingColor-0 mt-[18px] mb-[6px]">
                Place of Animals
              </h5>
              <p className="font-Nunito font-medium text-PrimaryColor-0 mb-5">
                8:30AM - 6:00PM
              </p>
              <Link to={"/"}>
                <button className="font-Nunito font-medium text-HeadingColor-0 text-[15px] flex gap-2 items-center">
                  View Map
          ...
          <div className="relative">
            ...
            <h4 className="font-Nunito font-bold text-[22px] text-HeadingColor-0 mt-6 mb-7">
            ...
            <p className="font-Nunito text-TextColor-0 font-light mt-9 mb-[52px]">
              Corporate strategy frameworks to provide a robust synopsis high
            ...
            <div className="flex flex-col sm:flex-row gap-5 sm:items-center">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <button className="font-Nunito font-semibold text-lg text-HeadingColor-0 transition-all duration-500 hover:text-PrimaryColor-0">
                    +31 65 792 63 11
                  </button>
                </div>
              </div>
