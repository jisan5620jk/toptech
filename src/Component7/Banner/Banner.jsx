      ...
      <div className="Container">
        <div className="grid lg:grid-cols-2 items-center gap-16 lg:gap-0">
          ...
          <div className="sm:flex justify-center lg:justify-end relative hidden">
            ...
            />
            <div className="absolute top-[30rem] 2xl:top-[22rem] -left-4 flex items-center gap-3 pl-3 pr-9 py-3 rounded-l-full rounded-tr-full rounded-br bg-white bg-opacity-55 backdrop-filter backdrop-blur-[5px] border-2 border-white animate-wiggle">
              <div>
            ...
            <div className="absolute bottom-5 -right-20 flex items-center gap-3 pl-3 pr-9 py-3 rounded-r-full rounded-bl-full rounded-tl bg-white bg-opacity-55 backdrop-filter backdrop-blur-[5px] border-2 border-white animate-movebtn">
              <div>
            ...
            <div className="absolute top-[10rem] -right-[9rem] flex flex-col items-center gap-3 px-11 py-8 rounded-2xl bg-white bg-opacity-55 backdrop-filter backdrop-blur-[5px] border-2 border-white animate-dance3">
              <div>
