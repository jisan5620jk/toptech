  ...
  return (
    <div className="relative z-10 group rounded-md overflow-hidden">
      ...
      <div className="w-11/12 -mt-[42px] bg-[#f5f8ed] rounded-md overflow-hidden px-4 md:px-8 pb-8 transition-all duration-500 relative z-10 after:absolute after:left-0 after:top-0 after:w-[5px] after:h-full after:bg-PrimaryColor-0 after:z-10 before:-z-10 before:absolute before:left-0 before:w-[5px] before:h-full before:bg-SecondaryColor-0 before:transition-all before:duration-500 group-hover:before:w-full group-hover:-mt-[86px]">
        ...
        />
        <h6 className="font-Nunito font-medium text-TextColor-0 transition-all duration-500 group-hover:text-white pt-[30px]">
          {projectSubTitle}
        </h6>
        <h5 className="font-Nunito font-semibold text-HeadingColor-0 text-[26px] lg:text-2xl xl:text-[26px] transition-all duration-500 group-hover:text-white pt-1">
          {projectTitle}
        </h5>
        <div className="-mt-[42px] transition-all duration-500 opacity-0 group-hover:mt-0 group-hover:border-white group-hover:opacity-100">
          <Link to={projectUrl}>
            <button className="font-Nunito font-medium text-white text-[17px] flex gap-2 items-center pt-3">
              {buttonTitle}
              {buttonIcon}
            </button>
          </Link>
