  ...
  return (
    <div className="border border-BorderColor2-0 rounded-md overflow-hidden group">
      <div className="relative overflow-hidden">
        ...
        />
        <h6 className="font-Nunito text-white px-5 py-2 rounded absolute top-5 -left-1/4 transition-all duration-500 bg-PrimaryColor-0 group-hover:left-5">
          {thumbContent}
        </h6>
      </div>
      <div className="px-4 sm:px-8">
        ...
        <p className="font-Nunito font-light text-TextColor-0 mb-8">
          {blogListDesc}
        </p>
      </div>
