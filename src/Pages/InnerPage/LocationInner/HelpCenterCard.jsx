...
const HelpCenterCard = ({
  ...
  return (
    <div className="text-center relative z-10 before:absolute before:left-0 before:bottom-0 before:w-full before:h-[80%] before:bg-white before:rounded-md before:-z-10 pb-[50px]">
