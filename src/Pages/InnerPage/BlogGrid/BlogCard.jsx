  ...
  return (
    <div className="bg-[#f3f4f8] group transition-all duration-500 hover:bg-white hover:shadow-cases rounded-md">
      ...
      <div className="px-5 sm:px-7 pb-7">
        <Link to={blogUrl}>
          <button className="font-Nunito text-left font-semibold text-xl sm:text-[22px] lg:text-xl xl:text-[22px] text-HeadingColor-0 mt-7 mb-3">
            {blogTitle}
          </button>
        </Link>
        <p className="font-Nunito font-light text-TextColor-0 pb-8">
          {blogDesc}
        </p>
        <Link to={blogUrl}>
