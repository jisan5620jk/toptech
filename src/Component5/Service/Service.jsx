    ...
    <section className="py-[120px] bg-[url(/images/service5-bg.jpg)] bg-cover bg-center bg-no-repeat relative z-10">
      <div className="Container">
        <div className="text-center">
          ...
          <h1 className="font-Rajdhani font-bold text-xl leading-7 sm:text-[38px] sm:leading-[46px] md:text-[42px] md:leading-[50px] lg:text-[34px] lg:leading-[40px] xl:text-[42px] xl:leading-[50px] 2xl:text-[42px] 2xl:leading-[50px] text-HeadingColor-0 mb-4">
