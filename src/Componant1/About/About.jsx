  ...
  return (
    <section className="py-[120px] bg-BodyBg-0 bg-no-repeat bg-center bg-cover relative">
      <div className="Container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[92px] lg:gap-10 2xl:gap-[92px] items-center">
          <div className="relative">
            <img src={aboutThumb} draggable="false" />
            <div className="absolute top-0 left-0">
              <div className="bg-PrimaryColor-0 pb-6 pt-5 flex flex-col justify-between overflow-hidden rounded-lg h-[208px] w-[170px] items-center text-center relative z-10 before:absolute before:top-1/2 before:-translate-y-1/2 before:left-1/2 before:-translate-x-1/2 before:w-8 before:h-[2px] before:bg-white after:absolute after:-top-14 after:-left-[2px] after:w-[174px] after:h-[170px] after:bg-[#1164ED] after:-z-10 after:rounded-full">
                <CountUp
                  start={-9}
                  end={22}
                  suffix="+"
                  className="text-[56px] font-Rajdhani font-bold text-white"
                />
                <h6 className="font-Rajdhani text-lg leading-5 font-semibold text-white">
            ...
            <img
              src={aboutShape}
              draggable="false"
              className="absolute bottom-6 right-10 animate-movebtn hidden sm:block"
            />
          </div>
          <div className="relative">
            ...
            <h1 className="font-Rahdhani font-bold text-[22px] leading-8 sm:text-[38px] sm:leading-[48px] md:text-[44px] md:leading-[54px] lg:text-[32px] lg:leading-[42px] xl:text-[36px] xl:leading-[46px] 2xl:text-[42px] 2xl:leading-[52px] text-HeadingColor-0 mt-5 mb-3">
            ...
            <div className="grid grid-cols-2 gap-y-[30px] my-10">
              <div className="flex gap-5 items-center">
                ...
                <div className="flex-1">
                  <h5 className="font-Rajdhani font-semibold text-[22px] lg:text-lg xl:text-xl 2xl:text-[22px] text-HeadingColor-0">
