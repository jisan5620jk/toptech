    ...
    <section className="relative bg-BodyBg-0 pt-28 z-10 before:absolute before:top-0 before:left-0 before:w-full before:h-[80%] before:-z-10 before:bg-[url('/images/subscribe-bg.jpg')] before:bg-cover before:bg-no-repeat before:bg-center">
      <div className="Container">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
          <div>
            <h1 className="font-Rahdhani font-bold text-xl leading-7 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[30px] lg:leading-[40px] xl:text-[36px] xl:leading-[46px] 2xl:text-[42px] 2xl:leading-[52px] text-white mt-[18px] mb-4">
          ...
          <div className="flex justify-end">
            <form action="#" className="inline-block relative">
              <input
                ...
                className="w-[402px] h-[66px] py-2 px-6 rounded bg-transparent border border-white text-white font-Nunito placeholder:text-white"
              />
              <button
                type="submit"
